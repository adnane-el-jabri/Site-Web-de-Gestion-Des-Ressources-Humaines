...
table tbody tr:nth-child(even) {
  background-color: rgba(223, 223, 223, 0.664);
}
...
<meta name="theme-color" content="#7952b3">
  ...
  <div class="container">
       ...
       <div style="margin-top:75px;margin-left:15px" class="panel panel-success margetop">
    
    <div style="color:black" class="panel-body">
    <form method="get" action="employes.php">
       <div style="color:black" class="search-box" style="margin-left:5em">
       <button type="submit" class="btn-search"><i style="color:black;" class="fa fa-search " ></i></button>
           <input style="color:black" type="text" name="nomE" class="input-search" placeholder="chercher par nom">
  </div>
     </form>
        </div>
    <form method="get" action="modifieremployes.php">
    <div style="margin-top:-50px" class="panel panel-primary margetop">
