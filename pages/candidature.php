...
<style>
  body{
    background-image: url(../images/candidature.jpg);
...
<meta name="theme-color" content="#7952b3">
  ...
  <body style="background-image: url(../images/one.png);
    background-attachment: fixed;
    background-size: cover;">
    <?php include('menu.php');?>
    <br>
    <h1 style="margin-top:-60px;">Formulaire de candidature</h1>
    <br> 
  ...
  <div  class="myform">
    ...
    <div class="row">
    <div class="form-group col-6">
    <input style="margin-left:340px;width:30%;" type="submit" id="soumettre" class="btn btn-primary" value="soumettre">
    </div>    
    </div>    
