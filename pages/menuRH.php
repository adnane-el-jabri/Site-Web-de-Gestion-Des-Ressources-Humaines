...
<nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
   ...
   <img class="navbar-brand" src="../images/lo.png" width="135px" height="75px">
    ...
    <div style="margin-left:280px" class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav me-auto mb-2 mb-md-0">
        ...
        <form class="d-flex">
        <a class="btn btn-outline-danger" style="border-radius: 25px;" href="deconnecter.php">Se déconnecter</a>
      </form>
    </div>
 </div>
</nav>
